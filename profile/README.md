...
Erarbeitet wird die Empfehlung durch die AG Minimaldatensatz. Die AG Minimaldatensatz wurde 2022 von den Fachstellen Museum und Mediathek Fotografie/Ton der Deutschen Digitalen Bibliothek (DDB) und der AG Digitalisierung der Konferenz der Museumsberatungsstellen in den Ländern (KMBL) sowie digiS Berlin initiiert. Mitglieder der AG sind Vertreter*innen folgender Organisationen, Projekte und Zusammenschlüsse: Institut für Museumsforschung - Staatliche Museen zu Berlin - Stiftung Preußischer Kulturbesitz, Fachgruppe Dokumentation im Deutschen Museumsbund (DMB), Koordinierungsstelle für wissenschaftliche Universitätssammlungen in Deutschland - Humboldt-Universität zu Berlin, digiCULT-Verbund eG, museum-digital Deutschland e. V., Landesstelle für die nichtstaatlichen Museen in Bayern, Museumsverband Hessen e. V., Museumsverband des Landes Brandenburg e. V., Museumsverband Rheinland-Pfalz e. V., Museumsverband Sachsen-Anhalt e. V., NFDI4Culture, NFDI4Memory, NFDI4Objects, Museum für Naturkunde Berlin, Übersee-Museum Bremen, Klassik Stiftung Weimar, Staatliche Kunstsammlungen Dresden, SODa Sammlungen Objekte Datenkompetenzen, Verbundzentrale des GBV (VZG), Universitätsbibliothek Ludwig-Maximilians-Universität München, Gemeinsame Normdatei.  
...
Bitte schicken Sie Ihr Feedback an: [info@minimaldatensatz.de](mailto:info@minimaldatensatz.de).  
